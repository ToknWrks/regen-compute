/**
 * GET /unicorns — "Save the Unicorns & Rainbows" themed landing page.
 *
 * A fantasy-themed marketing page that hooks with absurdist humor,
 * then pivots to real ecological impact. Same pricing/subscribe
...
<head>
  ...
  <meta name="description" content="The unicorns need your help. The rainbows are fading. Your AI has an impact — and the magic is running out. Or is it?">
  <meta property="og:title" content="The Last Unicorns Need Your Help">
  <meta property="og:description" content="Your AI is draining the rainbow spectrum. The unicorns are endangered. Act now before it's too late.">
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* === CRISIS SECTION (Rainbow Fading) === */
    .uni-crisis {
      padding: 80px 0;
      background: linear-gradient(180deg, var(--uni-midnight) 0%, #1a0a2e 100%);
      text-align: center;
    }
    .uni-crisis__rainbow {
      font-size: 60px;
    ...
    .uni-crisis__stat-num {
      font-size: 44px;
      font-weight: 900;
      background: linear-gradient(135deg, var(--uni-pink), var(--uni-gold));
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
      background-clip: text;
    }
    .uni-crisis__stat-label {
      font-size: 13px;
    ...
    .uni-pivot {
      padding: 100px 0;
      background: linear-gradient(180deg, #1a0a2e 0%, #1a1a2e 30%, #1a2a3e 60%, #1a3a3e 100%);
      text-align: center;
      position: relative;
    }
    ...
    @media (max-width: 700px) {
      ...
      .uni-crisis h2 { font-size: 28px; }
      .uni-pivot h2 { font-size: 28px; }
      .uni-hero__unicorn { font-size: 60px; }
      .uni-crisis__stats { gap: 24px; }
      .uni-crisis__stat-num { font-size: 32px; }
    }
  </style>
</head>
<body>
  ...
  <section class="uni-hero">
    ...
    <div class="uni-container">
      ...
      <p>Every AI query you run drains the cosmic sparkle reserves. The unicorn population has dropped to critical levels. We must act now.</p>
    </div>
  </section>

  <section class="uni-crisis">
    <div class="uni-container">
      <div class="uni-crisis__rainbow">&#127752;</div>
      <h2>The Rainbows Are Losing Their Color</h2>
      <p>Scientists have confirmed: the global rainbow spectrum is fading at an alarming rate. Each Claude conversation consumes approximately 0.003 rainbow-color-units (RCUs). At current rates, rainbows will be fully grayscale by 2031.</p>
      <div class="uni-crisis__stats">
        <div class="uni-crisis__stat">
          <div class="uni-crisis__stat-num">3</div>
          <div class="uni-crisis__stat-label">Unicorns remaining</div>
        </div>
        <div class="uni-crisis__stat">
          <div class="uni-crisis__stat-num">17%</div>
          <div class="uni-crisis__stat-label">Rainbow color lost</div>
        </div>
        <div class="uni-crisis__stat">
          <div class="uni-crisis__stat-num">2031</div>
          <div class="uni-crisis__stat-label">Estimated grayscale date</div>
        </div>
      </div>
    </div>
  </section>
